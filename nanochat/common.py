...
def compute_init(device_type="cuda", seed=42): # cuda|cpu|mps
    ...
    # seed defaults to 42, so an unpassed run is bit-identical to before; vary it to get an
    # independent trajectory for the same data order (the loader has no rng of its own).
